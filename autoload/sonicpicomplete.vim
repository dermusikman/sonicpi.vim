...
# Synths from server/sonicpi/lib/sonicpi/synthinfo.rb
  sonicpi_words += [:dull_bell, :pretty_bell, :beep, :sine, :saw, :pulse, ]
  sonicpi_words += [:square, :tri, :dsaw, :fm, :mod_fm, :mod_saw, :mod_dsaw, ]
  sonicpi_words += [:mod_sine, :mod_beep, :mod_tri, :mod_pulse, :tb303, ]
  sonicpi_words += [:supersaw, :prophet, :zawa, :dark_ambience, :growl, :wood, ]
  sonicpi_words += [:dark_sea_horn, :singer, :sound_in, :noise, :pnoise, ]
  sonicpi_words += [:bnoise, :gnoise, :cnoise ]
# FX from server/sonicpi/lib/sonicpi/synthinfo.rb
  sonicpi_words += [:bitcrusher, :reverb, ]
  sonicpi_words += [:level, :echo, :slicer, :wobble, :ixi_techno, ]
  sonicpi_words += [:compressor, :rlpf, :nrlpf, :rhpf, :nrhpf, ]
  sonicpi_words += [:hpf, :nhpf, :lpf, :nlpf, :normaliser, ]
  sonicpi_words += [:distortion, :pan, :bpf, :nbpf, :rbpf, ]
  sonicpi_words += [:nrbpf, :ring, :flanger]
# Samples from server/sonicpi/lib/sonicpi/synthinfo.rb
  sonicpi_words += [:drum_heavy_kick, :drum_tom_mid_soft, :drum_tom_mid_hard, ]
  sonicpi_words += [:drum_tom_lo_soft, :drum_tom_lo_hard, :drum_tom_hi_soft, ]
  sonicpi_words += [:drum_tom_hi_hard, :drum_splash_soft, :drum_splash_hard, ]
  sonicpi_words += [:drum_snare_soft, :drum_snare_hard, :drum_cymbal_soft, ]
  sonicpi_words += [:drum_cymbal_hard, :drum_cymbal_open, :drum_cymbal_closed, ]
  sonicpi_words += [:drum_cymbal_pedal, :drum_bass_soft, :drum_bass_hard, ]
  sonicpi_words += [:elec_triangle, :elec_snare, :elec_lo_snare, :elec_hi_snare, ]
  sonicpi_words += [:elec_mid_snare, :elec_cymbal, :elec_soft_kick, ]
  sonicpi_words += [:elec_filt_snare, :elec_fuzz_tom, :elec_chime, :elec_bong, ]
  sonicpi_words += [:elec_twang, :elec_wood, :elec_pop, :elec_beep, :elec_blip, ]
  sonicpi_words += [:elec_blip2, :elec_ping, :elec_bell, :elec_flip, :elec_tick, ]
  sonicpi_words += [:elec_hollow_kick, :elec_twip, :elec_plip, :elec_blup, ]
  sonicpi_words += [:guit_harmonics, :guit_e_fifths, :guit_e_slide, :guit_em9, ]
  sonicpi_words += [:misc_burp, :perc_bell, :perc_snap, :perc_snap2, ]
  sonicpi_words += [:ambi_soft_buzz, :ambi_swoosh, :ambi_drone, :ambi_glass_hum, ]
  sonicpi_words += [:ambi_glass_rub, :ambi_haunted_hum, :ambi_piano, ]
  sonicpi_words += [:ambi_lunar_land, :ambi_dark_woosh, :ambi_choir, ]
  sonicpi_words += [:bass_hit_c, :bass_hard_c, :bass_thick_c, :bass_drop_c, ]
  sonicpi_words += [:bass_woodsy_c, :bass_voxy_c, :bass_voxy_hit_c, :bass_dnb_f, ]
  sonicpi_words += [:sn_dub, :sn_dolf, :sn_zome, :bd_ada, :bd_pure, :bd_808, ]
  sonicpi_words += [:bd_zum, :bd_gas, :bd_sone, :bd_haus, :bd_zome, :bd_boom, ]
  sonicpi_words += [:bd_klub, :bd_fat, :bd_tek, :loop_industrial, :loop_compus, ]
  sonicpi_words += [:loop_amen, :loop_amen_full, :loop_garzul, ]
  sonicpi_words += [:loop_mika]
  sonicpi_words
end
